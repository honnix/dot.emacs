...
"Toggle Vimish-Fold mode in many buffers.
Specifically, Vimish-Fold mode is enabled in all buffers where `vimish-fold-mode' would do it.

With prefix ARG, enable Vimish-Fold-Global mode if ARG is positive; otherwise, disable it.
