...
This mode runs the hook `go-dot-mod-mode-hook', as the final or penultimate step during
initialization.
...
This mode runs the hook `go-dot-work-mode-hook', as the final or penultimate step during
initialization.
...
In addition to any hooks its parent mode `asm-mode' might have run, this mode runs the hook
`go-asm-mode-hook', as the final or penultimate step during initialization.
