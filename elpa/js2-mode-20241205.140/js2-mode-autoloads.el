...
In addition to any hooks its parent mode `js-mode' might have run, this mode runs the hook
`js2-mode-hook', as the final or penultimate step during initialization.
