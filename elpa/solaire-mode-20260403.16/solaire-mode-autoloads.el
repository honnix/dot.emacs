...
"Toggle Solaire mode in many buffers.
Specifically, Solaire mode is enabled in all buffers where `turn-on-solaire-mode' would do it.

With prefix ARG, enable Solaire-Global mode if ARG is positive; otherwise, disable it.
