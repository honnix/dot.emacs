...
(register-definition-prefixes "pyim-candidates" '("pyim-candidate"))
...
(register-definition-prefixes "pyim-dhashcache" '("pyim-d"))
...
(register-definition-prefixes "pyim-entered" '("pyim-"))
