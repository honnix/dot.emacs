;;; system-packages-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn PACK &optional ARGS)" t)
(autoload 'system-packages-package-installed-p "system-packages"
...
(provide 'system-packages-autoloads)
