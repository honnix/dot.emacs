    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!restartCommand) {
            restartCommand = vscode.commands.registerCommand('go.languageserver.restart', () => __awaiter(this, void 0, void 0, function* () {
                ...
                if (false) {
                    yield suggestGoplsIssueReport(`Looks like you're about to manually restart the language server.`);
                }
...
function suggestGoplsIssueReport(msg) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const selected = yield vscode.window.showInformationMessage(`${msg} Would you like to report a gopls issue ? `, 'Yes', 'Next time', 'Never');
        switch (selected) {
            case 'Yes':
                ...
                const execFile = util.promisify(cp.execFile);
                yield execFile(latestConfig.path, ['bug'], { env: goEnv_1.toolExecutionEnvironment() });
                break;
            case 'Next time':
                break;
            case 'Never':
